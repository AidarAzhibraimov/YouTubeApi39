...
import com.kg.geektech.youtubeapi39.core.extensions.showToast
import com.kg.geektech.youtubeapi39.core.network.NetworkConnection
import com.kg.geektech.youtubeapi39.core.ui.BaseActivity
...
class PlaylistActivity : BaseActivity<PlayListViewModel, ActivityPlaylistBinding>() {
    ...
    private fun initRecycler(playlist: Playlist?) {
        ...
        binding.recycler.adapter = playlist?.items?.let { AdapterPlaylist(it, this::clickListener) }
    }
